...
from yaa_core.shared.logging_config import JSONFormatter, setup_logging
...
class TestMetricsModule:
    ...
    def test_모듈_import_성공(self):
        ...
        from yaa_app.api.metrics import (
    ...
    def test_no_op_메트릭_labels_동작(self):
        ...
        from yaa_app.api.metrics import _NoOpMetric
    ...
    def test_경로_정규화(self):
        ...
        from yaa_app.api.metrics import _normalize_path
    ...
    def test_prometheus_가용성_플래그(self):
        ...
        from yaa_app.api.metrics import _HAS_PROMETHEUS
    ...
    def test_prometheus_미설치_graceful_fallback(self):
        ...
        from yaa_app.api.metrics import _build_counter, _build_histogram, _NoOpMetric

        # _HAS_PROMETHEUS를 False로 패치하여 no-op 동작 확인
        with patch("yaa_app.api.metrics._HAS_PROMETHEUS", False):
