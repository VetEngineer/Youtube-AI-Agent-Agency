...
import httpx
import pytest
from yaa_agents.media_generator.agent import MediaGeneratorAgent, MediaGeneratorError
from yaa_agents.media_generator.image_gen import (
    ImageGenerator,
    ImageGeneratorError,
    MidjourneyGenerator,
    NanubananGenerator,
)
from yaa_agents.media_generator.voice_gen import (
...
class TestElevenLabsVoiceGenerator:
    ...
    async def test_generate_success(self, voice_request: VoiceGenerationRequest) -> None:
        ...
        with patch("yaa_agents.media_generator.voice_gen.httpx.AsyncClient") as mock_client_cls:
