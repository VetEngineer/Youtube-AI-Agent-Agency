...
import pytest
from yaa_agents.brand_researcher.collector import CollectedSource, CollectionResult
...
class TestRAGConfig:
    ...
    def test_기본_설정_값(self):
        from yaa_agents.brand_researcher.rag.config import RAGConfig
...
class TestBrandIndexer:
    ...
    def test_텍스트_청킹(self):
        from yaa_agents.brand_researcher.rag.config import RAGConfig
        from yaa_agents.brand_researcher.rag.indexer import BrandIndexer
...
class TestBrandIndexerIntegration:
    ...
    def test_인덱싱_후_검색(self, tmp_path):
        from yaa_agents.brand_researcher.rag.config import RAGConfig
        from yaa_agents.brand_researcher.rag.indexer import BrandIndexer
        from yaa_agents.brand_researcher.rag.retriever import BrandRetriever
...
class TestAgentRAGIntegration:
    ...
    def test_rag_비활성화시_원본_유지(self):
        from yaa_agents.brand_researcher.agent import BrandResearcherAgent
    ...
    @patch("yaa_agents.brand_researcher.agent.BrandResearcherAgent._get_rag_retriever")
