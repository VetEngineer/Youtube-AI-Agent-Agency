    ...
    <div className="space-y-6">
      ...
      >
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setOpen(false)} disabled={createChannel.isLoading}>
              취소
            </Button>
            <Button onClick={handleCreate} disabled={!name.trim() || createChannel.isLoading}>
              {createChannel.isLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
              생성
            </Button>
          </DialogFooter>
        </DialogContent>
